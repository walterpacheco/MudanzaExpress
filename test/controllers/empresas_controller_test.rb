...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { nombre: @empresa.nombre, rut: @empresa.rut, telefono: @empresa.telefono } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { nombre: @empresa.nombre, rut: @empresa.rut, telefono: @empresa.telefono } }
